...
def menu(screen):
    ...
    button_rect3 = pygame.Rect(235, 650, 150, 50)
    button_surface3 = pygame.Surface((150, 50))
    text_rect3 = text3.get_rect(
        center=(button_surface.get_width() / 2,
                button_surface.get_height() / 2))
    text4 = f1.render('Магазин', 1, (180, 0, 0))
    button_rect4 = pygame.Rect(235, 500, 150, 50)
